...
Public Class WinScan
    ...
    Private objTEPClientSettings As TEPClientSettings = DataAccess.GetTEPClientSettings
        ...
        Try
            ...
            Select Case WinMain.objClientSettings.DeviceType
                ...
                Case "MAGTEK"
                    ...
                    'WinMain.MyAppLog.WriteToLog("WinMain.WinMain_Closing() MTUSCRAOpenDevice()" & intResult)
...
#Region "TEP"
    ...
    Private Sub cmdWarning_Click(sender As Object, e As System.Windows.RoutedEventArgs) Handles cmdWarning.Click
        ...
        Try
            ...
            objTEPSwipeScanDetail.SwipeScanID = intSwipeScanID
            objTEPSwipeScanDetail.ClientID = WinMain.objClientSettings.ClientID
            objTEPSwipeScanDetail.CitationID = Me.txtCitation.Text
            objTEPSwipeScanDetail.ICRID = Me.txtICR.Text
