...
#Region "Control Bound Subs"
    ...
    Private Sub cmdSearch_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles cmdSearch.Click
        ...
        Catch exICE As InvalidCastException
            WinMain.MyAppLog.WriteToLog("IVS", exICE.ToString, EventLogEntryType.Error)
        Catch ex As Exception
            DataAccess.NewException(ex)
            WinMain.MyAppLog.WriteToLog("IVS", ex.ToString, EventLogEntryType.Error)
        End Try
    ...
    Private Sub dgSearchResults_CmdDelete_Click()
        ...
        Try
            If System.Windows.MessageBox.Show("Are you sure you want to delete the Swipe data?", "WARNING!", MessageBoxButton.OKCancel, MessageBoxImage.Warning) = MessageBoxResult.OK Then
...
#End Region
    ...
    Private Sub dgSearchResults_CmdView_Click()
        ...
        Try
            ...
            WinScan = New WinScan(intSwipeScanID)
            WinScan.Owner = Me
            WinScan.ShowDialog()
