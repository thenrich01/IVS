...
#Region "Control Bound Subs"
    ...
    Private Sub cmdScan_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles cmdScan.Click
        ...
        Try
            If objClientSettings.DeviceType = "LS_40_USB" Or objClientSettings.DeviceType = "LS_150_USB" Or objClientSettings.DeviceType = "M210/260" Then

                Dim winCTSScan As WinScanImage
                winCTSScan = New WinScanImage()
                winCTSScan.Owner = Me
                winCTSScan.ShowDialog()

            ElseIf objClientSettings.DeviceType = "MAGTEK" Or objClientSettings.DeviceType = "M200/250" Then

                Dim winMagTekScan As WinScan
                winMagTekScan = New WinScan()
    ...
    Private Sub cmdLogon_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles cmdLogon.Click
        ...
        Try
            ...
            If intIVSUserID > 0 Then
                MyAppLog.WriteToLog("USERID:" & intIVSUserID)
                ...
                'MyAppLog.WriteToLog("Password:" & objUserDetail.Password)
                'MyAppLog.WriteToLog("isUserAdmin:" & isUserAdmin)
                'MyAppLog.WriteToLog("isUserAlertAble:" & isUserAlertAble)
                'MyAppLog.WriteToLog("isUserSearchAble:" & isUserSearchAble)
...
#Region "Custom Subs/Functions"
    ...
    Private Sub ClientSettingsLoad()
        ...
        Try
            ...
            MyAppLog.WriteToLog("IVS Client ID: " & intClientID)

            objClientSettings = DataAccess.GetClientSettings(intClientID)


            'MyAppLog.WriteToLog("objClientSettings DefaultUser ID: " & objClientSettings.DefaultUser)
