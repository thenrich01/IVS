...
#Region "Control Bound Subs"
    ...
    Public Sub New(ByVal SwipeScanID As Integer, ByVal SwipeScanType As String)
        ...
        Try
            ...
            objSwipeScanNavigateInfo = DataAccess.SwipeScanNavigatePrevious(WinMain.intIVSUserID, WinMain.intClientID, SwipeScanID)
    ...
    Private Sub WinCompare_KeyDown() Handles Me.KeyDown, Me.MouseDown
        intViewTimeCountDown = WinMain.objClientSettings.ViewingTime
    End Sub
