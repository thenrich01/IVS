...
Imports System.Net
Imports IVS.Data.IVS.IVSDecodeService
Imports IVS.AppLog

Public Class DataAccess

    Public Shared MyAppLog As New ApplicationLog(ApplicationLog.DateEncodingType.YYYYMMDD, True, "IVS.WS.IVS", DateFormat.GeneralDate)
    ...
    Public Shared Function OpenConnection() As SqlConnection
        ...
        Try
            cnnString = ConfigurationManager.ConnectionStrings("IVS.WS.IVS.My.MySettings.ConnectionString").ConnectionString
            cnn = New SqlConnection(cnnString)

        Catch ex As Exception
            MyAppLog.WriteToLog("IVS.Data.WebService.OpenConnection()" & ex.ToString)
        End Try
    ...
    Public Shared Function IsIVSLicenseValid(ByVal LicenseGuid As Guid) As Boolean
        ...
        Catch ex As Exception
            ...
            MyAppLog.WriteToLog("IVS.Data.WebService.IsIVSLicenseValid()" & ex.ToString)
    ...
    Public Shared Sub LicenseException(ByVal LicenseGuid As Guid, IPAddress As String, IVSService As String, ByVal IVSFunction As String)
        ...
        Catch ex As Exception
            ...
            MyAppLog.WriteToLog("IVS.Data.WebService.LicenseException()" & ex.ToString)
