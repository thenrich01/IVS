...
Public Class WinBatch
    ...
    Private Sub BWCTSIdentify_RunWorkerCompleted(ByVal Result As CTSDeviceInfo)
        ...
        Try
            ...
            Else
                ...
                WinMain.MyAppLog.WriteToLog("WinBatch.BWCTSIdentify_RunWorkerCompleted() Unable to connect to CTS device")
    ...
    Private Sub cmdBatchStart_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles cmdBatchStart.Click
        ...
        Try
            ...
            objBatchInfo.ClientID = WinMain.objClientSettings.ClientID
            objBatchInfo.UserID = WinMain.intIVSUserID
            objBatchInfo.ImageLocation = WinMain.objClientSettings.ImageLocation
