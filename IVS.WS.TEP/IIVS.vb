...
Public Interface IIVS
    ...
    <OperationContract()> _
    Function SwipeScanNavigateFirstDetail(ByVal LicenseGuid As Guid, ByVal UserID As Integer, ByVal ClientID As Integer) As SwipeScanDetail

    <OperationContract()> _
    Function SwipeScanNavigatePreviousDetail(ByVal LicenseGuid As Guid, ByVal UserID As Integer, ByVal ClientID As Integer, ByVal SwipeScanID As Integer) As SwipeScanDetail

    <OperationContract()> _
    Function SwipeScanNavigatePositionDetail(ByVal LicenseGuid As Guid, ByVal SwipeScanID As Integer) As SwipeScanDetail

    <OperationContract()> _
    Function SwipeScanNavigateNextDetail(ByVal LicenseGuid As Guid, ByVal UserID As Integer, ByVal ClientID As Integer, ByVal SwipeScanID As Integer) As SwipeScanDetail

    <OperationContract()> _
    Function SwipeScanNavigateLastDetail(ByVal LicenseGuid As Guid, ByVal UserID As Integer, ByVal ClientID As Integer) As SwipeScanDetail
    ...
    <OperationContract()> _
    Function GetTEPViolations(ByVal LicenseGuid As Guid) As List(Of TEPViolations)

    <OperationContract()> _
    Function GetTEPClientSettings(ByVal LicenseGuid As Guid) As TEPClientSettings

    <OperationContract()> _
    Sub NewDataSwipeScan_TEP(ByVal LicenseGuid As Guid, ByVal TEPSwipeScanDetail As TEPSwipeScanDetail)

    <OperationContract()> _
    Sub NewDataSwipeScan_Violation(ByVal LicenseGuid As Guid, ByVal TEPSwipeScanViolation As TEPSwipeScanViolations)

    <OperationContract()> _
    Function GetSwipeScanDetail_TEP(ByVal LicenseGuid As Guid, ByVal SwipeScanID As Integer) As TEPSwipeScanDetail

    <OperationContract()> _
    Function GetSwipeScanDetail_Violations(ByVal LicenseGuid As Guid, ByVal SwipeScanID As Integer) As List(Of TEPSwipeScanViolations)

    <OperationContract()> _
    Function IsCitationUsedAlready(ByVal LicenseGuid As Guid, ByVal CitationID As String) As Boolean

    <OperationContract()> _
    Sub NewException(ByVal LicenseGuid As Guid, ByVal ex As Exception, ByVal ClientID As String)

    <OperationContract()> _
    Sub NewExceptionDetail(ByVal LicenseGuid As Guid, ByVal ClientID As String, ByVal ExSource As String, ByVal ExTargetSite As String, ByVal ExType As String, ByVal ExMessage As String, ByVal ExData As String, ByVal ExStackTrace As String)
