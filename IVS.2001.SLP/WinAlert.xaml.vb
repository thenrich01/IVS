...
#Region "Control Bound Subs"
    ...
    Public Sub New(ByVal AlertDetail As AlertDetail, ByVal IVSUserID As Integer, Optional ByVal EditMode As Boolean = False)
        ...
        Dim objUserDetail As UserDetail
        ...
        Try
            ...
            If objAlertDetail.AlertID > 0 Then
                ...
                If (objUserDetail.AdminFlag = False) Then
                    Me.cmdDelete.Visibility = Windows.Visibility.Hidden
                End If
    ...
    Private Sub cmdSave_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles cmdSave.Click
        ...
        Try
            ...
            objNewAlertDetail.UserID = intUserID
