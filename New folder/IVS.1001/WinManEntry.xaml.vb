...
#Region "Control Bound Subs"
    ...
    Public Sub New(ByVal IVSUserID As Integer, ByVal ClientID As Integer, ByVal CallingWindow As String)
        ...
        Try
            ...
            If objClientSettings.DisableCCSave = False Then
            ...
            If objClientSettings.DeviceType = "CTS" Then
    ...
    Private Sub cmdSave_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles cmdSave.Click
        ...
        Try
            If cboIDType.SelectedIndex > 0 Then
                ...
                objSwipeScanDetail.UserID = intIVSUserID
                objSwipeScanDetail.ClientID = objClientSettings.ClientID
                objSwipeScanDetail.CCIssuer = strCCIssuer

                If MyCallingWindow = "CTS" Then
                    WinCTS.ManualEntrySwipeScanID = DataAccess.NewDataSwipeScanManual(objSwipeScanDetail)
