...
Public Class WinSearch
    ...
    Public Sub New(ByVal ClientID As Integer, ByVal IVSUserID As Integer, ByVal DeviceType As String, ByVal ImageLocation As String, ByVal ViewingTime As Integer)
...
#Region "Control Bound Subs"
    ...
    Private Sub WinSearch_Loaded(sender As Object, e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        Try
            ...
            Me.cboStations.SelectedValue = intClientID
