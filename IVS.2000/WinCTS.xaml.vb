    ...
    Private Sub cmdCompare_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles cmdCompare.Click
        ...
        Try
            If isImageEdited = True Then
                ...
                If System.Windows.MessageBox.Show("Save image updates before comparing the last 2 scans?", "WARNING!", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning) = MessageBoxResult.OK Then
    ...
    Private Sub SwipeScanDetail_LoadByObject(ByVal SwipeScanDetailObject As SwipeScanDetail, ByVal FrontImage As Bitmap, ByVal BackImage As Bitmap)
        ...
        Try
            ...
            If objClientSettings.ImageSave = True Then
                ...
                If File.Exists(objClientSettings.ImageLocation & "\" & intSwipeScanID & "f.jpg") = True Then
                    MyAppLog.WriteToLog("WinCTS.SwipeScanDetail_LoadByObject() File exists: " & objClientSettings.ImageLocation & "\" & intSwipeScanID & "f.jpg")
                    imgEditedImage = New Bitmap(objClientSettings.ImageLocation & "\" & intSwipeScanID & "f.jpg")
                End If
