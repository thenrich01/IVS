...
Imports System.Text
Imports IVS.Data.TEP.IVSDecodeService
...
Public Class DataAccess
    ...
    Public Shared Function OpenConnection() As SqlConnection
        ...
        Try
            cnnString = ConfigurationManager.ConnectionStrings("IVS.WS.TEP.My.MySettings.ConnectionString").ConnectionString
    ...
    Public Shared Sub NewException(ByVal ex As Exception, ByVal ClientID As String)
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("ExType", ex.GetType.ToString)
            cmd.Parameters.AddWithValue("ExMessage", ex.Message.ToString)
            cmd.Parameters.AddWithValue("ExData", sb.ToString)
            cmd.Parameters.AddWithValue("ExStackTrace", ex.StackTrace.ToString)
    ...
    Public Shared Sub NewException(ByVal ClientID As String, ByVal ExSource As String, ByVal ExTargetSite As String, ByVal ExType As String, ByVal ExMessage As String, ByVal ExData As String, ByVal ExStackTrace As String)
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("ExTargetSite", ExTargetSite)
            cmd.Parameters.AddWithValue("ExType", ExType)
            cmd.Parameters.AddWithValue("ExMessage", ExMessage)
            cmd.Parameters.AddWithValue("ExData", ExData)
...
#Region "SwipeScans"
    ...
    Public Shared Function NewDataSwipeScan(ByVal LicenseGuid As Guid, ByVal IPAddress As String, ByVal SwipeScanInfo As SwipeScanInfo) As SwipeScanDetail
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("ActivityDetails", SwipeScanInfo.SwipeScanRawData)
            ...
            If SwipeScanInfo.ScanType <> "C" Then
                ...
                Catch ex As Exception
                    ...
                    cmd.Parameters.AddWithValue("IPAddress", IPAddress)
                    cmd.Parameters.AddWithValue("IVSFunction", "DecodeData")
                    cmd.Parameters.AddWithValue("ActivityDetails", ex.ToString)
    ...
    Public Shared Function NewDataSwipeScanManual(ByVal IPAddress As String, ByVal SwipeScanDetail As SwipeScanDetail) As Integer
        ...
        Try
            ...
            Select Case SwipeScanDetail.CardType
                ...
                Case "Drivers License Or State ID"
                    NewDataSwipeScanManual_DLID(IPAddress, SwipeScanDetail)
                Case "Credit Card"
                    NewDataSwipeScanManual_CC(IPAddress, SwipeScanDetail)
                Case "Military ID Card"
                    NewDataSwipeScanManual_MID(IPAddress, SwipeScanDetail)
                Case "INS Employee Authorization Card"
                    NewDataSwipeScanManual_INS(IPAddress, SwipeScanDetail)
                Case "Check"
                    NewDataSwipeScanManual_CK(IPAddress, SwipeScanDetail)
    ...
    Private Shared Sub NewDataSwipeScanManual_CC(ByVal IPAddress As String, ByVal SwipeScanDetail As SwipeScanDetail)
    ...
    Private Shared Sub NewDataSwipeScanManual_DLID(ByVal IPAddress As String, ByVal SwipeScanDetail As SwipeScanDetail)
    ...
    Private Shared Sub NewDataSwipeScanManual_MID(ByVal IPAddress As String, ByVal SwipeScanDetail As SwipeScanDetail)
    ...
    Private Shared Sub NewDataSwipeScanManual_INS(ByVal IPAddress As String, ByVal SwipeScanDetail As SwipeScanDetail)
    ...
    Private Shared Sub NewDataSwipeScanManual_CK(ByVal IPAddress As String, ByVal SwipeScanDetail As SwipeScanDetail)
    ...
    Public Shared Function SwipeScanNavigateFirstDetail(ByVal IPAddress As String, ByVal UserID As Integer, ByVal ClientID As Integer) As SwipeScanDetail
        ...
        Try
            ...
            sb.Append(objSwipeScanDetail.SwipeScanID)
            ...
            cmd.Parameters.AddWithValue("IPAddress", IPAddress)
            cmd.Parameters.AddWithValue("IVSFunction", "SwipeScanNavigateFirstDetail")
            cmd.Parameters.AddWithValue("ActivityDetails", sb.ToString)
           ...
           cnn.Close()
            ...
            objSwipeScanDetail = GetSwipeScanDetail(IPAddress, intSwipeScanID, strSwipeScanType)
    ...
    Public Shared Function SwipeScanNavigatePreviousDetail(ByVal IPAddress As String, ByVal UserID As Integer, ByVal ClientID As Integer, ByVal SwipeScanID As Integer) As SwipeScanDetail
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("IPAddress", IPAddress)
            cmd.Parameters.AddWithValue("IVSFunction", "SwipeScanNavigatePreviousDetail")
            cmd.Parameters.AddWithValue("ActivityDetails", sb.ToString)
    ...
    Public Shared Function SwipeScanNavigatePositionDetail(ByVal IPAddress As String, ByVal SwipeScanID As Integer) As SwipeScanDetail
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("IPAddress", IPAddress)
            cmd.Parameters.AddWithValue("IVSFunction", "SwipeScanNavigatePositionDetail")
            cmd.Parameters.AddWithValue("ActivityDetails", sb.ToString)
    ...
    Public Shared Function SwipeScanNavigateNextDetail(ByVal IPAddress As String, ByVal UserID As Integer, ByVal ClientID As Integer, ByVal SwipeScanID As Integer) As SwipeScanDetail
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("IPAddress", IPAddress)
            cmd.Parameters.AddWithValue("IVSFunction", "SwipeScanNavigateNextDetail")
            cmd.Parameters.AddWithValue("ActivityDetails", sb.ToString)
    ...
    Public Shared Function SwipeScanNavigateLastDetail(ByVal IPAddress As String, ByVal UserID As Integer, ByVal ClientID As Integer) As SwipeScanDetail
        ...
        Try
            ...
            cmd.Parameters.AddWithValue("IPAddress", IPAddress)
            cmd.Parameters.AddWithValue("IVSFunction", "SwipeScanNavigateLastDetail")
            cmd.Parameters.AddWithValue("ActivityDetails", sb.ToString)
