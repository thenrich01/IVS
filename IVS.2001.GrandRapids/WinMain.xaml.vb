...
Class WinMain
    ...
    Public Sub New()
        ...
        Catch ex As Exception
            ...
            DataAccess.NewException(ex.Source, ex.TargetSite.ToString, ex.GetType.ToString, ex.Message.ToString, ex.Data.ToString, ex.StackTrace.ToString)
...
#Region "Control Bound Subs"
    ...
    Private Sub WinMain_Loaded(sender As Object, e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        Catch ex As Exception
            DataAccess.NewException(ex.Source, ex.TargetSite.ToString, ex.GetType.ToString, ex.Message.ToString, ex.ToString, ex.StackTrace.ToString)
            MessageBox.Show(ex.ToString, "TEST")
