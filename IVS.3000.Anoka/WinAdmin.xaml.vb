...
Public Class WinAdmin
    ...
    Private strVisitingName As String
    ...
    Public Sub New()
        ...
        Try
            ...
            Me.dgVisiting.ItemsSource = DataAccess.GetVisiting_Anoka(WinMain.objClientSettings.ClientID)
...
#Region "Control Bound Subs"
    ...
    Private Sub WinAdmin_Loaded(sender As Object, e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        Try
            ...
            Me.txtClientInternalLoc.Text = WinMain.objClientSettings.InternalLoc
            ...
            AddHandler txtClientInternalLoc.TextChanged, AddressOf TextChanged
    ...
    Private Sub cmdSave_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles cmdSave.Click
        ...
        Try
            ...
            objNewClientSettings.InternalLoc = txtClientInternalLoc.Text

            DataAccess.SaveClientSettings_Anoka(objNewClientSettings)
    ...
    Private Sub txtNewVisiting_TextChanged(sender As Object, e As System.Windows.Controls.TextChangedEventArgs) Handles txtNewVisiting.TextChanged

        Try

            If Me.txtNewVisiting.Text <> "" Then

                Me.cmdEditVisiting.IsEnabled = True
                Me.cmdNewVisiting.IsEnabled = True
            Else

                Me.cmdEditVisiting.IsEnabled = False
                Me.cmdNewVisiting.IsEnabled = False
            End If
    ...
    Private Sub dgVisiting_SelectionChanged(sender As Object, e As System.Windows.Controls.SelectionChangedEventArgs) Handles dgVisiting.SelectionChanged
        ...
        Try
            ...
            If dgVisiting_SelectedRow.Count > 0 Then
                ...
                strVisitingName = dgVisiting_SelectedRow(0).VisitingName
    ...
    Private Sub dgVisiting_CmdEdit_Click()

        Try
            Me.txtNewVisiting.Text = strVisitingName
            Me.cmdNewVisiting.Visibility = Windows.Visibility.Hidden
            Me.cmdEditVisiting.Visibility = Windows.Visibility.Visible
    ...
    Private Sub cmdEditVisiting_Click(sender As Object, e As System.Windows.RoutedEventArgs) Handles cmdEditVisiting.Click

        Dim objVisitingDetail As New Visiting

        Try
            objVisitingDetail.VisitingID = intVisitingID
            objVisitingDetail.VisitingName = Me.txtNewVisiting.Text
            objVisitingDetail.ActiveFlag = True
            objVisitingDetail.LocationID = WinMain.objClientSettings.Location
            objVisitingDetail.ClientID = WinMain.objClientSettings.ClientID

            DataAccess.UpdateVisiting(objVisitingDetail)

            Me.cmdEditVisiting.IsEnabled = False
            Me.txtNewVisiting.Text = Nothing

            Me.cmdNewVisiting.Visibility = Windows.Visibility.Visible
            Me.cmdEditVisiting.Visibility = Windows.Visibility.Hidden
    ...
    Private Sub cmdNewVisiting_Click(sender As Object, e As System.Windows.RoutedEventArgs) Handles cmdNewVisiting.Click
        ...
        Try
            ...
            DataAccess.NewVisiting(objVisitingDetail)
